...
export class Completions extends ClientSDK {
    ...
    async create(
        ...
        return unwrapAsync(completionsCreate(this, completion, xLog10Organization, options));
    }
    ...
    async update(
        ...
        return unwrapAsync(
            completionsUpdate(this, completionId, completion, xLog10Organization, options)
        );
    }
    ...
    async listUngraded(
        ...
        return unwrapAsync(completionsListUngraded(this, xLog10Organization, options));
    }
}
