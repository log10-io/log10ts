...
/** @internal */
export const CreateGlobals$inboundSchema: z.ZodType<CreateGlobals, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const CreateRequest$inboundSchema: z.ZodType<CreateRequest, z.ZodTypeDef, unknown> = z
    .object({
        "X-Log10-Organization": z.string().optional(),
