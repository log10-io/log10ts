...
/** @internal */
export const ChatCompletionResponseMessageFunctionCall$outboundSchema:
  z.ZodType<
...
export namespace ChatCompletionResponseMessageFunctionCall$ {
  ...
  export const inboundSchema =
    ChatCompletionResponseMessageFunctionCall$inboundSchema;
  /** @deprecated use `ChatCompletionResponseMessageFunctionCall$outboundSchema` instead. */
  export const outboundSchema =
    ChatCompletionResponseMessageFunctionCall$outboundSchema;
