...
export namespace Logprobs$ {
    export const inboundSchema: z.ZodType<Logprobs, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Logprobs> = z
        .object({
    ...
    export const inboundSchema: z.ZodType<CreateChatCompletionResponse, z.ZodTypeDef, unknown> = z
        ...
        .transform((v) => {
            return {
                ...
                created: v.created,
                model: v.model,
                ...(v.system_fingerprint === undefined
                    ? null
                    : { systemFingerprint: v.system_fingerprint }),
                object: v.object,
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateChatCompletionResponse> = z
        ...
        .transform((v) => {
            return {
                ...
                created: v.created,
                model: v.model,
                ...(v.systemFingerprint === undefined
                    ? null
                    : { system_fingerprint: v.systemFingerprint }),
                object: v.object,
                ...(v.usage === undefined ? null : { usage: v.usage }),
            };
        });
